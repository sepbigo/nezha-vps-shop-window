<template>
  <div class="mt-6">
    <div class="flex flex-col gap-2 items-start justify-between">
      ...
      <div class="grid grid-cols-3 gap-2">
        <Button variant="secondary"
          ...
          :class="{ 'border-primary': item === store.preferences.customTheme }" v-for="item in store.themeList"
    ...
    <div class="mt-5 flex items-center justify-between">
      ...
      <Switch :model-value="store.preferences.useSemitransparent" @update:model-value="store.toggleSemitransparent">
      </Switch>
    </div>
    <div class="mt-5 flex items-center justify-between">
...
<script setup>import { Button } from '@/components/shadcn/ui/button';
